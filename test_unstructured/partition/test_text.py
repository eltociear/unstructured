...
@pytest.mark.parametrize("filename,encoding", [('fake-text.txt', 'utf-8'), ('fake-text.txt', None), ('fake-text-utf-16-be.txt', 'utf-16-be')])
...
@pytest.mark.parametrize("filename,encoding,error", [('fake-text.txt', 'utf-16', UnicodeDecodeError), ('fake-text-utf-16-be.txt', 'utf-16', UnicodeError)])
